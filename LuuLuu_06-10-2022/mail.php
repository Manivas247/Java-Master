...
$mail->Username = 'support@luuluuhomes.com';// SMTP username
$mail->Password = 'Support@2022';// SMTP password

$mail->setFrom('support@luuluuhomes.com');//Your application NAME and EMAIL
$mail->Subject = $subject;
$mail->Body    = $htmlContent;
$mail->addAddress('sales@luuluuhomes.com');// Target email
...
<html lang="en">
  ...
  <body>
    <div class="container999">
      ...
      <p class="back">Go back to the <a href="/source/contact.html">Contact Page</a>.</p>
      <img class="sent" src="/source/assets/sent.gif" alt="" />
    </div>
  </body>
  <script>
  if (window.history.replaceState) {
    ...
    header("Location: /source/contact.html");
}
?>