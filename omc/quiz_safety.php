...
if(isset($_SESSION['email'])){
	...
	$query = "SELECT * FROM safety_questions WHERE question_number = $number";
	...
	//Get Choices
	$query = "SELECT * FROM safety_options WHERE question_number = $number";
    ...
    if($total_questions <1){
        ...
        $message1 = "Questions yet to be uploaded";
    }
                ...
                <div class="container-fluid ">
					...
					echo "<h4>" . $message . "</h4>";
                        ...
                        <div class="form-group">
                            <form method="POST" action="quizprocess_safety.php">
                                <ul style="list-style: none;">
                                    <?php while($row=mysqli_fetch_assoc($choices)){ ?>
                                    <li><input type="radio" name="choice" required
                                            value="<?php echo $row['id']; ?>">&emsp;<?php echo $row['coption']; ?></li>
                                    <?php } ?>
