            ...
            ?>
                ...
                <div class="container-fluid ">
                    ...
                    <div class="container">
                        ...
                        <a href="addquiz_safety.php" class="btn btn-primary">Add Question</a>
                        <?php
                        // $sql = "SELECT * FROM result WHERE email='$email' AND attend_date = CURRENT_TIMESTAMP";
                        // $result = mysqli_query($con, $sql);
                        $date = date("Y-m-d");
                        $query = "SELECT * FROM safety_result WHERE email=? AND attend_date =? ";
                        ...
                        echo "<p> <font color=red>Please try again tomorrow</font> </p>";     
                            ...
                            ?>
                        <a href="quiz_safety.php?n=1" class="btn btn-secondary">Start Quize</a>
                        <?php  }
                        ?>
                        ...
                        <div class="table-wrapper-scroll-y my-custom-scrollbar">
                            <table class="table table-striped mb-0" style="margin-top: 10px; ">
                                ...
                                <tbody>
                                    <?php
            $date = date("Y-m-d");
            $query = "SELECT * FROM safety_result WHERE attend_date =? ORDER BY score1 DESC ";
            $q = mysqli_stmt_init($con);
            mysqli_stmt_prepare($q, $query);
