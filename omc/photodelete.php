...
if (isset($_GET['id'])) {
    ...
    $stmt = $pdo->prepare('SELECT * FROM images1 WHERE id = ?');
    ...
    if (isset($_GET['confirm'])) {
        if ($_GET['confirm'] == 'yes') {
            ...
            $stmt = $pdo->prepare('DELETE FROM images1 WHERE id = ?');
            $stmt->execute([ $_GET['id'] ]);
            // Output msg
            ...
            ?>
                ...
                <div class="container-fluid ">
                    ...
                    <div class="content delete">
                        ...
                        <p><?=$msg?></p>
                        <?php else: ?>
                        <p>Are you sure you want to delete <?=$image['name']?>'s photo</p>
                        <div class="yesno">
                            <a href="photodelete.php?id=<?=$image['id']?>&confirm=yes">Yes</a>
                            <a href="photodelete.php?id=<?=$image['id']?>&confirm=no">No</a>
                        </div>
                        <?php endif; ?>
                    </div>
